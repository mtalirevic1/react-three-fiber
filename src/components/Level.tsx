...
const BlockEnd = ({position = [0, 0, 0]}: { position?: [number, number, number] }) => {
...
export const BlockSpinner = ({position = [0, 0, 0]}: { position?: [number, number, number] }) => {
...
export const BlockLimbo = ({position = [0, 0, 0]}: { position?: [number, number, number] }) => {
    const obstacle = useRef<RapierRigidBody>(null)
...
export const BlockAxe = ({position = [0, 0, 0]}: { position?: [number, number, number] }) => {
    const obstacle = useRef<RapierRigidBody>(null)
    const [timeOffset] = useState(() => Math.random() * Math.PI * 2)
